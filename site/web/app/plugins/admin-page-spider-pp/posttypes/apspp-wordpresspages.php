...
$apspider_which_option_is_selected = get_site_option('apspider_radio_editmenu');
if ($apspider_which_option_is_selected[0] == 'option1') { //option1=display
	add_action( 'admin_bar_menu', 'apspp_edit_wp_pg', 996 );
	add_action('apspp_extra_styles', 'apspp_extra_styles', 10);

}

function apspp_edit_wp_pg( $wp_admin_bar ) {
