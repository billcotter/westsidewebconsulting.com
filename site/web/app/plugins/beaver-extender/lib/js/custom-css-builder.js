...
jQuery(document).ready(function($) {
	...
	$('#show-hide-custom-css-builder').click(function() {
		$('#beaver-extender-custom-php-builder').hide();
		$('#beaver-extender-custom-css-builder').animate({'height': 'toggle'}, { duration: 300 });
		// Variables
		var beaver_extender_css_builder_nav_all = $('.beaver-extender-css-builder-nav-all');
		
		beaver_extender_css_builder_nav_all.click(function() {
			var css_nav_id = $(this).attr('id');
			$('.beaver-extender-all-css-builder').hide();
			$('#'+css_nav_id+'-box').show();
			beaver_extender_css_builder_nav_all.removeClass('beaver-extender-options-nav-active');
			$('#'+css_nav_id).addClass('beaver-extender-options-nav-active');
		});
	});
	...
	$('#css-builder-output-insert').click(function() {
		...
		$('#beaver-extender-custom-css').insertAtCaret(new_custom_css);
