<?php
$csshero_version="2.30";
$csshero_version_styles="2.30";
...
<html id="cssherohtml" data-child-theme-slug="<?php echo $html_theme_slug; ?>">
    ...
    <body id="csshero-workarea">
		...
		<script type='text/javascript' src='//csshero.org/production/heroes-loader-2019.php?<?php echo $ademo ?>version=<?php echo $csshero_version .$rocket_mode_string ?>&key=<?php echo  wpcss_check_license() ?>&theme=<?php echo $theme_slug ?>&thv=<?php $my_theme = wp_get_theme(); echo   $my_theme->get( 'Version' ); ?>&plugins=<?php echo wpcss_active_site_plugins() ?><?php if (isset($_GET['rocket_mode_version'])) echo "&rocket_mode_version=".$_GET['rocket_mode_version'] ?>'></script> 
